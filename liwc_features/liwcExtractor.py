...
import re
import pickle
liwcPath = '/Users/Ankush/Desktop/liwctest/data/LIWC2007_English_plus_txt.dic'
import tokenizer as btke
...
class liwcExtractor():
    def __init__(self,
        ...
        if ltokenizer is None:
            self.ltokenizer = self.nltk_tokenize
    ...
    def extractFromDoc(self, document):
        tokens = self.ltokenizer(document)
    ...
    def nltk_tokenize(self, message):
    	...
    	'''
        tokenlist = btke.tokenize(message)
    	return tokenlist
